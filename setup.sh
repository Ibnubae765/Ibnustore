...
TIMES="10"
CHATID="6400687182"
KEY="7773121556:AAHLP5Kb1ZVI_DE7v5JgC_9tkQD-tpC_wlY"
...
clear;clear;clear
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "\033[46m              ID STORE \033[0m"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 3
clear
...
# Ekstrak angka utama versi (misal dari "22.04" jadi "22")
...
clear
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/Ibnubae765/Izin/main/ip | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/Ibnubae765/Izin/main/ip | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
...
Exp1=$(curl https://raw.githubusercontent.com/Ibnubae765/Izin/main/ip | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
echo -e "\e[32mloading...\e[0m"
clear
REPO="https://raw.githubusercontent.com/Ibnubae765/Ibnustore/main/"
wget https://raw.githubusercontent.com/Ibnubae765/Ibnustore/main/files/udp-custom.sh && chmod +x udp-custom.sh && ./udp-custom.sh
start=$(date +%s)
secs_to_human() {
...
clear
restart_system() {
USRSC=$(wget -qO- https://raw.githubusercontent.com/Ibnubae765/Izin/main/ip | grep $ipsaya | awk '{print $2}')
EXPSC=$(wget -qO- https://raw.githubusercontent.com/Ibnubae765/Izin/main/ip | grep $ipsaya | awk '{print $3}')
...
"'&reply_markup={"inline_keyboard":[[{"text":"⭐ᴏʀᴅᴇʀ⭐","url":"https://t.me/Idstore135"},{"text":"⭐ɪɴꜱᴛᴀʟʟ⭐","url":"https://wa.me/6282181410507"}]]}'
...
wget raw.githubusercontent.com/Ibnubae765/Ibnustore/main/files/limit.sh && chmod +x limit.sh && ./limit.sh
cd
